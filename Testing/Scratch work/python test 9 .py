...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.camera_for_sprites = arcade.Camera2D(SCREEN_WIDTH, SCREEN_HEIGHT)
        self.camera_for_gui = arcade.Camera2D(SCREEN_WIDTH, SCREEN_HEIGHT)
        arcade.cam
    def setup(self):
        ...
        # Create the player
        self.player_sprite = arcade.Sprite("character_maleAdventurer_walk7.png", SPRITE_SCALING_PLAYER)
        ...
        wall = arcade.Sprite("coin_01.png", SPRITE_SCALING_BOX)
        wall.center_x = 300
        wall.center_y = 200
